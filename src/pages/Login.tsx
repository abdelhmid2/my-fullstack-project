          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                type="text"
                className="appearance-none rounded-lg relative block w-full pr-10 px-3 py-3 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-gray-700 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="appearance-none rounded-lg relative block w-full pr-10 pl-10 px-3 py-3 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-gray-700 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10"
